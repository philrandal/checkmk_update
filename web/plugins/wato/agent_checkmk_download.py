...
def _valuespec_special_agents_checkmk_download():
    return Dictionary(
        elements=[
            ('no-cert-check',
             FixedValue(
...
rulespec_registry.register(
    HostRulespec(
        ...
        name='special_agents:checkmk_download',
        valuespec=_valuespec_special_agents_checkmk_download,
    ))
